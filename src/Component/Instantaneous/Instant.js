...
FormControl,
  Grid,  IconButton,  InputLabel,  List, ListItemText, ListSubheader,
  MenuItem,
  Stack, Select, TextField, Tooltip, Typography,} from '@mui/material';
...
function Instant() {
  ...
  const KAH_S2=useAPi(Base_Url+"kah/102")
  const KAH_S3=useAPi(Base_Url+"kah/103")
  const KAH_S4=useAPi(Base_Url+"kah/104") 
  const NAT_S1=useAPi(Base_Url+"nat/201")
  const NAT_S2=useAPi(Base_Url+"nat/202")
  const NAT_S3=useAPi(Base_Url+"nat/203")
  const NAT_S4=useAPi(Base_Url+"nat/204")
  const NAT_S5=useAPi(Base_Url+"nat/205")
  const NAT_S6=useAPi(Base_Url+"nat/206")
  const NAT_S7=useAPi(Base_Url+"nat/207")
  const PAT_S1=useAPi(Base_Url+"pat/301")
  const PAT_S2=useAPi(Base_Url+"pat/302")
  const PAT_S3=useAPi(Base_Url+"pat/303")
  const PAT_S4=useAPi(Base_Url+"pat/304")
  const PAT_S5=useAPi(Base_Url+"pat/305")
  const PAT_S6=useAPi(Base_Url+"pat/306")    
  ...
  const CheckChange = () => {
    switch (true) {
      ...
      case division === "KAHRAKMAFF" && station === "3 - Chopra Farm":
        KAH_S3.getReq()
        DisplayData1(KAH_S3.APIdata);
        Set_Pump(3);
        break;
      case division === "KAHRAKMAFF" && station === "4 - Khadri":
        KAH_S4.getReq()
        DisplayData1(KAH_S4.APIdata);
        Set_Pump(4);
        break;
      ...
      case division === "PRATITNAGAR" && station === "1-Zone-1":
        PAT_S1.getReq()
        DisplayData1(PAT_S1.APIdata);
        Set_Pump(5);
        break;
      case division === "PRATITNAGAR" && station === "2-Zone-2":
        PAT_S2.getReq()
        DisplayData1(PAT_S2.APIdata);
        Set_Pump(6);
        break;
      case division === "PRATITNAGAR" && station === "3-Zone-3(I-Well-I)":
        PAT_S3.getReq()
        DisplayData1(PAT_S3.APIdata);
        Set_Pump(7);
        break;
      case division === "PRATITNAGAR" && station === "4-Zone-3(I-Well-II)":
        PAT_S4.getReq()
        DisplayData1(PAT_S4.APIdata);
        Set_Pump(8);
        break;
      case division === "PRATITNAGAR" && station === "5-Zone-4":
        PAT_S5.getReq()
        DisplayData1(PAT_S5.APIdata);
        Set_Pump(9);
        break;
      case division === "PRATITNAGAR" && station === "6-Zone-5":
        PAT_S6.getReq()
        DisplayData1(PAT_S6.APIdata);
        Set_Pump(10);
        break;
  ...
  return (
    <>
        ...
        <div className="Instant-main-area">
          <div className="Instant-dropdown-area">
            ...
            <div className="last-update">
              <span>Last Updated :-{allValues.tag34}
                 </span>
              <span>Date :- {allValues.tag33}
      ...
      <div className="instant-Footer">
        <p className="instant-Footer-text">Design And Devlop By - Shetal Enterprises 18 Cross 2B Tapovan Enclave Raipur Road, Dehradun.</p>
      </div>
...
const validationSchema=Yup.object({   // form Validation for Form Fields.
...
const FormModal = ({ open, onClose,initialvalues,title,division,station,btnSubmitTxt,Base_Url ,pump_id}) => {
  ...
  const formik = useFormik({
	...
	return (
	  <Dialog open={open}>
		  <DialogTitle textAlign="center">{title} {division} ({station})</DialogTitle>
      <DialogContent >
        <form>
            <Stack
              sx={{ m:1,
              ...
              <TextField fullWidth
                id="R_Max_CURRENT"
                name="R_Max_CURRENT"
                label={(formik.touched.R_Max_CURRENT && formik.errors.R_Max_CURRENT)||'R_Max_CURRENT'}
                size='small'
                value={formik.values.R_Max_CURRENT}
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
                error={formik.touched.R_Max_CURRENT && Boolean(formik.errors.R_Max_CURRENT)}
              ...
              <TextField fullWidth
                id="Y_Max_CURRENT"
                name="Y_Max_CURRENT"
                label={(formik.touched.Y_Max_CURRENT && formik.errors.Y_Max_CURRENT)||'Y_Max_CURRENT'}
                size='small'
                value={formik.values.Y_Max_CURRENT}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.Y_Max_CURRENT && Boolean(formik.errors.Y_Max_CURRENT)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="B_Max_CURRENT"
                name="B_Max_CURRENT"
                label={(formik.touched.B_Max_CURRENT && formik.errors.B_Max_CURRENT)||'B_Max_CURRENT'}
                size='small'
                value={formik.values.B_Max_CURRENT}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.B_Max_CURRENT && Boolean(formik.errors.B_Max_CURRENT)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="R_Max_VOLTAGE"
                name="R_Max_VOLTAGE"
                label={(formik.touched.R_Max_VOLTAGE && formik.errors.R_Max_VOLTAGE)||'R_Max_VOLTAGE'}
                size='small'
                value={formik.values.R_Max_VOLTAGE}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.R_Max_VOLTAGE && Boolean(formik.errors.R_Max_VOLTAGE)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
               ...
               <TextField fullWidth
                id="Y_Max_VOLTAGE"
                name="Y_Max_VOLTAGE"
                label={(formik.touched.Y_Max_VOLTAGE && formik.errors.Y_Max_VOLTAGE)||'Y_Max_VOLTAGE'}
                size='small'
                value={formik.values.Y_Max_VOLTAGE}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.Y_Max_VOLTAGE && Boolean(formik.errors.Y_Max_VOLTAGE)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              ...
              <TextField fullWidth
                id="B_Max_VOLTAGE"
                name="B_Max_VOLTAGE"
                label={(formik.touched.B_Max_VOLTAGE && formik.errors.B_Max_VOLTAGE)||'B_Max_VOLTAGE'}
                size='small'
                value={formik.values.B_Max_VOLTAGE}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.B_Max_VOLTAGE && Boolean(formik.errors.B_Max_VOLTAGE)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="FIRST_ON_TIME"
                name="FIRST_ON_TIME"
                label={(formik.touched.FIRST_ON_TIME && formik.errors.FIRST_ON_TIME)||'FIRST_ON_TIME'}
                size='small'
                value={formik.values.FIRST_ON_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.FIRST_ON_TIME && Boolean(formik.errors.FIRST_ON_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="FIRST_OFF_TIME"
                name="FIRST_OFF_TIME"
                label={(formik.touched.FIRST_OFF_TIME && formik.errors.FIRST_OFF_TIME)||'FIRST_OFF_TIME'}
                size='small'
                value={formik.values.FIRST_OFF_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.FIRST_OFF_TIME && Boolean(formik.errors.FIRST_OFF_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="SECOND_ON_TIME"
                name="SECOND_ON_TIME"
                label={(formik.touched.SECOND_ON_TIME && formik.errors.SECOND_ON_TIME)||'SECOND_ON_TIME'}
                size='small'
                value={formik.values.SECOND_ON_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.SECOND_ON_TIME && Boolean(formik.errors.SECOND_ON_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="SECOND_OFF_TIME"
                name="SECOND_OFF_TIME"
                label={(formik.touched.SECOND_OFF_TIME && formik.errors.SECOND_OFF_TIME)||'SECOND_OFF_TIME'}
                size='small'
                value={formik.values.SECOND_OFF_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.SECOND_OFF_TIME && Boolean(formik.errors.SECOND_OFF_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="THIRD_ON_TIME"
                name="THIRD_ON_TIME"
                label={(formik.touched.THIRD_ON_TIME && formik.errors.THIRD_ON_TIME)||'THIRD_ON_TIME'}
                size='small'
                value={formik.values.THIRD_ON_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.THIRD_ON_TIME && Boolean(formik.errors.THIRD_ON_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
              <TextField fullWidth
                id="THIRD_OFF_TIME"
                name="THIRD_OFF_TIME"
                label={(formik.touched.THIRD_OFF_TIME && formik.errors.THIRD_OFF_TIME)||'THIRD_OFF_TIME'}
                size='small'
                value={formik.values.THIRD_OFF_TIME}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                error={formik.touched.THIRD_OFF_TIME && Boolean(formik.errors.THIRD_OFF_TIME)}
                //helperText={formik.touched.Code && formik.errors.Code}
              />
